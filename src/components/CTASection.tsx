      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-3xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 bg-background/10 backdrop-blur-sm rounded-full px-4 py-2 mb-6 animate-fade-in">
            ...
            <span className="text-primary-foreground text-sm font-medium">Join 1000+ students already learning</span>
          </div>
          ...
          <p className="text-lg text-primary-foreground/90 mb-10 animate-slide-up" style={{ animationDelay: '0.1s' }}>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center animate-slide-up" style={{ animationDelay: '0.2s' }}>
            <Button
              size="xl"
              className="bg-background text-primary hover:bg-background/90 shadow-xl hover:shadow-2xl hover:-translate-y-1 transition-all"
              asChild
            >
          ...
          <p className="text-primary-foreground/70 text-sm mt-6 animate-fade-in" style={{ animationDelay: '0.3s' }}>
