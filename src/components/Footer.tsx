      ...
      <div className="container mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-background/70 mb-6 max-w-sm">
              Connecting junior students with experienced senior mentors for personalized academic support within your college community.
            </p>
        ...
        <div className="mt-16 pt-8 border-t border-background/10 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <p className="text-background/60 text-sm flex items-center gap-1">
            Made with <Heart className="w-4 h-4 text-destructive fill-current" /> by GNIT Students
          </p>
        </div>
      </div>
    </footer>
